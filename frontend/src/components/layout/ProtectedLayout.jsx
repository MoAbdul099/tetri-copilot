...
const APP_LAYOUT_PATHS = ['/dashboard', '/settings', '/members', '/billing', '/customers', '/invoices', '/payments', '/receivables', '/collections', '/statements', '/expenses', '/approvals', '/reimbursements', '/expense-insights', '/budgets', '/recurring-expenses', '/files', '/compliance'];
