...
const Switch = React.forwardRef(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      'transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tetri-blue focus-visible:ring-offset-2',
      'disabled:cursor-not-allowed disabled:opacity-50',
      'data-[state=unchecked]:bg-slate-300 data-[state=checked]:bg-tetri-blue',
      className
    )}
    {...props}
    ref={ref}
