...
- branded workspace onboarding experience
- branded settings and company profile UI
...
- Branded onboarding/setup UI
- Branded workspace settings UI
- Branded company profile UI
...
All workspace and company setup screens must follow Tetri Copilot branding.
...
- workspace setup completion status if applicable
...
- branded setup layout
- dashboard redirect after setup completion
...
Workspace setup pages should use:
- clean SaaS onboarding layout
- spacious content sections
- soft background
- clear step progression if wizard is used
- Tetri logo where appropriate
- consistent page headings and descriptions
...
Use:
- Lucide React
- #1447e6 for primary icons
- #155dfc for secondary highlights
- #64748b for neutral icons
...
4. User completes:
   ...
   - localization
   - workspace settings
5. Setup marked completed if supported
...
5. Branded success feedback is shown
...
2. Enters user email
3. Selects role if applicable
4. Invitation created
5. Invitation flow stored for future onboarding
...
- Workspace setup should be completed before full dashboard access where applicable.

## Company Rules

- Every workspace should maintain one company profile.
- Company profile acts as operational business identity.
- Company profile should support future invoice, document, and compliance features.
...
- selected currency must exist and be active
- selected language must exist and be active
- default tax rate must be numeric and non-negative
- invoice due days must be positive
- reminder lead days must be non-negative
...
- Prevent public access to workspace settings
...
- workspace setup screen follows branding
- company form follows branding
- settings page follows branding
- responsive layout works
- loading/error/success states are branded
...
- advanced onboarding progress tracking
- branded onboarding tips and AI setup guidance
...
- Tetri branding is applied to all Slice 2 frontend screens
- UI uses docs/branding.md, Tailwind, and shadcn/ui consistently
